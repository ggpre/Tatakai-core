              ...
              Consumer(
                builder: (context, ref, _) {
                  ...
                  return Container(
                    ...
                    padding: const EdgeInsets.all(AppThemes.spaceSm),
                  ...
                  return ElevatedButton(
                    onPressed: isLoading ? null : () async {
                      ...
                      if (_isLogin) {
                        ...
                        await auth.signUpWithEmail(_emailController.text.trim(), _passwordController.text.trim(), username: _usernameController.text.trim());
                      }
                    ...
                    child: isLoading ? const SizedBox(height: 18, width: 18, child: CircularProgressIndicator(strokeWidth: 2, color: Colors.white)) : Text(
                ...
                Center(
                  child: TextButton(
                    ...
                    child: Text(
                      'Forgot Password?',
                      style: TextStyle(
                        color: AppThemes.accentPink.withOpacity(0.8),
                        fontSize: 14,
                      ),
                    ),
                  ),
